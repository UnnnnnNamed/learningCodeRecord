...
class SequentialMemory(Memory):
    ...
    def sample_and_split(self, batch_size, batch_idxs=None):
       ...
       # print(list(itertools.chain(*state0_batch)))
        return list(itertools.chain(*state0_batch)), action_batch, reward_batch, list(itertools.chain(*state1_batch)), terminal1_batch
